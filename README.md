# GenAI_Tutorials
A simple tutorial of python and GenAi using VsCode.. Lastly a flight booking app in accordance to agentic Ai with no external frameworks.  

INTRODUCTION TO GEMINI(introduction.py)

- Google family of LLMs
  - Large language models and multimodals
...
- simulating a flight booking application
